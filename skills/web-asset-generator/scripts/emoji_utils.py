...
EMOJI_DATABASE = {
    ...
    "🔒": ("lock", ["security", "secure", "privacy", "safe", "protect", "auth"], "tech"),
    "⚙️": ("gear", ["settings", "config", "system", "options", "preferences"], "tech"),
    "🖥️": ("desktop", ["computer", "desktop", "monitor", "screen", "display"], "tech"),
    "📡": ("satellite", ["network", "connect", "wireless", "signal", "broadcast"], "tech"),
    ...
    "🏆": ("trophy", ["winner", "award", "achievement", "success", "champion"], "business"),
    "🤝": ("handshake", ["partnership", "deal", "agreement", "collaboration"], "business"),
    "📋": ("clipboard", ["task", "list", "project", "manage", "organize"], "business"),
    ...
    "🧁": ("cupcake", ["bakery", "dessert", "sweet", "cake", "pastry"], "food"),
    "🍜": ("noodles", ["asian", "food", "noodles", "restaurant", "dining"], "food"),
    "🥤": ("drink", ["beverage", "drink", "juice", "smoothie", "fresh"], "food"),
    ...
    "🏋️": ("weightlifting", ["gym", "fitness", "strength", "workout", "training"], "health"),
    "🩺": ("stethoscope", ["medical", "health", "doctor", "clinic", "care"], "health"),
    "💊": ("pill", ["medicine", "pharmacy", "health", "drug", "treatment"], "health"),
    ...
    "🔬": ("microscope", ["science", "research", "lab", "study", "biology"], "education"),
    "📖": ("book", ["read", "book", "learning", "study", "knowledge"], "education"),
    ...
    "🖌️": ("brush", ["paint", "art", "design", "creative", "color"], "creative"),
    "🎭": ("theater", ["performance", "art", "show", "creative", "entertainment"], "creative"),
    ...
    "👥": ("people", ["community", "team", "social", "group", "users"], "social"),
    "📣": ("megaphone", ["marketing", "promote", "announce", "campaign", "broadcast"], "social"),
    ...
    "🏖️": ("beach", ["beach", "vacation", "travel", "resort", "summer"], "travel"),
    "🗼": ("tower", ["landmark", "tourism", "travel", "city", "architecture"], "travel"),
    ...
    "🎲": ("dice", ["game", "chance", "play", "fun", "random"], "entertainment"),
    "🏅": ("medal", ["achievement", "award", "sports", "winner", "competition"], "entertainment"),
    ...
    "🌸": ("blossom", ["flower", "spring", "beauty", "nature", "bloom"], "nature"),
    "🌊": ("wave", ["ocean", "water", "surf", "beach", "sea"], "nature"),
    "☀️": ("sun", ["sunny", "bright", "warm", "summer", "energy"], "nature"),
    ...
    "💎": ("diamond", ["premium", "luxury", "quality", "valuable", "elite"], "generic"),
    "💫": ("dizzy", ["exciting", "dynamic", "whirl", "star", "special"], "generic"),
}
